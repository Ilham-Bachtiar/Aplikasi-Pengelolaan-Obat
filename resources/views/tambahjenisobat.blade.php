...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-2">Tambah Jenis Obat</h1>
                </div><!-- /.col -->
            ...
            <div class="row justify-content-center">
                <div class="col-8">
                    <div class="card">
                        <div class="card-body">
                            <div class="card-body">
                                <form action="/insertjenisobat" method="POST" enctype="multipart/form-data">
                                    @csrf
                                   
                            <div class="col-auto">
                                <label for="exampleInputEmail1" class="form-label">Nama Jenis Obat</label>
                                <input type="text" name="nama_jenis_obat" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" id="nama_jenis_obat">
                            </div>
