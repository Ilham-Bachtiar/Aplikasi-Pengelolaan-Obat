...
<div class="content-wrapper">
  @foreach($data as $row)
  <script>alert('Selamat Datang {{ $row->fullname }}')</script>
  @endforeach
...
<div class="info-box-content">
  <span class="info-box-text">Jumlah Total Obat</span>
  <span class="info-box-number"> 
          ...
          <div class="col-12 col-sm-3 col-md-4">
            <div class="info-box mb-3">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-capsule-pill" viewBox="0 0 16 16">
  <path d="M11.02 5.364a3 3 0 0 0-4.242-4.243L1.121 6.778a3 3 0 1 0 4.243 4.243l5.657-5.657Zm-6.413-.657 2.878-2.879a2 2 0 1 1 2.829 2.829L7.435 7.536 4.607 4.707ZM12 8a4 4 0 1 1 0 8 4 4 0 0 1 0-8Zm-.5 1.042a3 3 0 0 0 0 5.917V9.042Zm1 5.917a3 3 0 0 0 0-5.917v5.917Z"/>
              ...
              <div class="info-box-content">
                <span class="info-box-text">Jumlah Obat Sdh Expired</span>
  ...
  <path d="M1.828 8.9 8.9 1.827a4 4 0 1 1 5.657 5.657l-7.07 7.071A4 4 0 1 1 1.827 8.9Zm9.128.771 2.893-2.893a3 3 0 1 0-4.243-4.242L6.713 5.429l4.243 4.242Z"/>
              ...
              <div class="info-box-content">
                <span class="info-box-text">Jumlah Obat Blm Expired</span>
                <span class="info-box-number"></span>
              </div>
              <!-- /.info-box-content -->
            </div>
          ...
          <div class="col-12 col-sm-3 col-md-4">
            <div class="info-box mb-3">
              <span class="info-box-icon bg-warning elevation-1">
              <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-people" viewBox="0 0 16 16" style="color:white;">
  ...
  <path d="M8.256 14a4.474 4.474 0 0 1-.229-1.004H3c.001-.246.154-.986.832-1.664C4.484 10.68 5.711 10 8 10c.26 0 .507.009.74.025.226-.341.496-.65.804-.918C9.077 9.038 8.564 9 8 9c-5 0-6 3-6 4s1 1 1 1h5.256Z"/>
              ...
              <div class="info-box-content">
                <span class="info-box-text">Jumlah User Aktif</span>
                <span class="info-box-number"></span>
              </div>
              <!-- /.info-box-content -->
            </div>
  ...
  <path d="M8.256 14a4.474 4.474 0 0 1-.229-1.004H3c.001-.246.154-.986.832-1.664C4.484 10.68 5.711 10 8 10c.26 0 .507.009.74.025.226-.341.496-.65.804-.918C9.077 9.038 8.564 9 8 9c-5 0-6 3-6 4s1 1 1 1h5.256Z"/>
              ...
              <div class="info-box-content">
                <span class="info-box-text">Jumlah User Belum Aktif</span>
                <span class="info-box-number"></span>
              </div>
              <!-- /.info-box-content -->
            </div>
