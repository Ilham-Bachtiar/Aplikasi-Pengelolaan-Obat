                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="col-auto">
                                ...
                                <input type="text" name="username" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" id="nama_jenis_obat">
                            </div>

                            <div class="col-auto">
                                <label for="exampleInputEmail1" class="form-label">Password</label>
                                <input type="password" name="password" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" id="nama_jenis_obat">
                            </div>
                      
                            <div class="col-auto">
                                <label for="exampleInputEmail1" class="form-label">Fullname</label>
                                <input type="text" name="fullname" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" id="nama_jenis_obat">
                            </div>
